...
years_genres_top = np.reshape(years_genres_top,[1,5])
...
for i in range(1,24):
    ...
    years_genres_top = np.append(years_genres_top,year_topgenres, axis=0)
...
years_genres_top = np.append(years, years_genres_top,axis=1)

print years_genres_top

np.savetxt("WarpedTour_top5genresyears.csv", years_genres_top, delimiter=",", fmt="%s")