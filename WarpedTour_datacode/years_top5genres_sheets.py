...
years_genres_top5 = np.reshape(years_genres_top5,[5,1])
...
for i in range(1,24):
    ...
    year_topgenres = np.reshape(year_topgenres, [5,1])
    years_genres_top5 = np.append(years_genres_top5,year_topgenres, axis=1)
...
years_genres_top5 = np.append(years, years_genres_top5,axis=0)

print years_genres_top5

np.savetxt("WarpedTour_yearstop5genres.csv", years_genres_top5, delimiter=",", fmt="%s")